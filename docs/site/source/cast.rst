...
and their lifecycle and comparability states. The baseline source run remains
optional until the subject has been initialized. A Timeline does not own an
active Contract or an active last-known-good pointer.
