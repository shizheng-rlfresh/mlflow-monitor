...
- execution compatibility checks
  ...
  1. Aggregate check outcomes into comparability status.
  2. Persist machine-readable reasons.
...
- run vs LKG (if exists)
  ...
  1. Generate findings from diffs.
...
- LKG (optional)
  ...
  1. Effective contract reference.
  2. Effective context fingerprint.
